...
#define MK_DOT    (0x37  /* 55 */)
#define MK_DOTS   (0x38  /* 56 */)
#define MK_DOTSH  (0x39  /* 57 */)
#define MK_DOTRH  (0x3a  /* 58 */)
#define MK_DUMP   (0x3b  /* 59 */)

/* Markab VM opcode dictionary */
#define MK_OPCODES_LEN (60)
