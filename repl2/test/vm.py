...
def test_instruction_decode_reset_ecall():
  ...
  print("(      emit                              )")
  print("(     }for                               )")
  print("( addr: 0  1   2 *3*      4     5        )")
  print("ASM{   U8 99 MTR  U8 E_READ ECALL")
  print("( addr:  6  7  8 9    10  11 *12* 13 14  )")
  print("        ZE BZ 12 0 RDROP RET DUP  U8 10")
  print("( addr: 15 16 17 18   19  20             )")
  print("        EQ BZ 21 0 RDROP RET")
  print("( addr: *21*                             )")
  print("        U8 E_WRITE ECALL")
  print("        DRBLT 3 0 RDROP               }ASM")
  code = bytearray()
  code.extend([U8, 99, MTR, U8, E_READ, ECALL])
  code.extend([ZE, BZ, 12, 0, RDROP, RET, DUP, U8, 10])
  code.extend([EQ, BZ, 21, 0, RDROP, RET])
